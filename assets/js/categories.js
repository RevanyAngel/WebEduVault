document.addEventListener('DOMContentLoaded', function () {
    ...
    const newReleaseBooks = [
        ...
        { title: 'Analisa Studi Kelayakan WebsiteDinas Kebudayaan Provinsi Riau Menggunakan Metode TELOS', author: 'Roby Ramadani', img: '/assets/images/B.png', pdf:'/assets/pdf/2.pdf' },
        { title: 'Penilaian KualitasQuality of Service Jaringan Internet WLAN PT. Solid Fintek', author: 'IndonesiaMuhammad Rizky', img: '/assets/images/C.png', pdf:'/assets/pdf/3.pdf' },
        ...
        { title: 'Penerapanan Model Deteksi Objek Untuk Robot Menggunakan Model SSD Di Lingkungan Simulasi ROS', author: 'Ilham Rizqyakbar', img: '/assets/images/E.png', pdf:'/assets/pdf/5.pdf' },
        { title: 'Rancang Bangun Aplikasi Manajemen Kos Menggunakan Framework Flutter', author: 'Daris Irfan Putrawanto', img: '/assets/images/F.png', pdf:'/assets/pdf/6.pdf' }
    ];
